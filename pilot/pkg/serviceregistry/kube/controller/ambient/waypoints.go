...
func fetchWaypointForTarget(
	...
	if namespace != nil {
		...
		if wp != nil {
			// check if this is a global service (i.e. autogenerated service entry w/ global label set)
			if strings.HasPrefix(o.Name, "autogen.") && peering.HasGlobalLabel(o.Labels) {
